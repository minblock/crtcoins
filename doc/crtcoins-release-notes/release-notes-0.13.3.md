CRTcoins Core version 0.13.3 is now available from:

  <https://download.crtcoins.org/crtcoins-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/crtcoins-project/crtcoins/blob/0.13/src/chainparams.cpp#L214).
