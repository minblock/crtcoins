# Support for Output Descriptors in CRTcoins Core

Since CRTcoins Core v0.17, there is support for Output Descriptors. This is a
...
on CRTcoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing CRTcoins Core wallets, a convenience function `combo` is
