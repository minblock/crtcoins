...
const char * const BITCOIN_CONF_FILENAME = "crtcoins.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CRTcoins";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CRTcoins";
#else
    // Unix
    return pathRet / ".crtcoins";
#endif
#endif
}
