...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " crtcoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  crtcoins-tx [options] <hex-tx> [commands]  Update hex-encoded crtcoins transaction\n" +
            "or:     crtcoins-tx [options] -create [commands]   Create hex-encoded crtcoins transaction\n" +
            "\n";
