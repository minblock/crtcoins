...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585939101, 576972, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0bb4cf8dbdf02c8fb2c34f143fddd05a4554fefea1aa55658d50f18a8e04b59c"));
        ...
        vSeeds.emplace_back("seed-a.crtcoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.crtcoinstools.com");
        vSeeds.emplace_back("dnsseed.crtcoinspool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.crtcoinstools.com");
        vSeeds.emplace_back("seed-b.crtcoins.loshan.co.uk");
