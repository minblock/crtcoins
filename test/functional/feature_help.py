...
"""Verify that starting crtcoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start crtcoins with -h for help text")
        ...
        self.log.info("Start crtcoins with -version for version information")
        ...
        self.log.info("Start crtcoinsd with -fakearg to make sure it does not start")
